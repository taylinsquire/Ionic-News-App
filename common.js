...
let NewsService = class NewsService {
    ...
    getTopStoriesObservable(page = 1, category = '') {
        if (!category) {
            return this.http
                .get(`https://newsapi.org/v2/top-headlines?country=us&pageSize=100&page=${page}`, this.headers)
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["shareReplay"])());
        }
        return this.http
            .get(`https://newsapi.org/v2/top-headlines?country=us&pageSize=100&category=${category}&page=${page}`, this.headers)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["shareReplay"])());
    }
    getStoriesBySearchObservable(search = 'news', category = '') {
        search = encodeURIComponent(search);
        if (category) {
            if (search === '') {
                return this.http
                    .get(`https://newsapi.org/v2/top-headlines?q=news&pageSize=100&category=${category}`, this.headers)
                    .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["shareReplay"])());
            }
            return this.http
                .get(`https://newsapi.org/v2/top-headlines?q=${search}&pageSize=100&category=${category}`, this.headers)
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["shareReplay"])());
        }
        if (search === '') {
            return this.http
...
let AuthService = class AuthService {
    constructor(firebaseAuth, db, router) {
        this.firebaseAuth = firebaseAuth;
        this.db = db;
        this.router = router;
        this.user$ = this.firebaseAuth.authState.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((authState) => {
            return this.db
    ...
    getUserObservable() {
        return this.user$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["mergeAll"])());
    }
    signOut() {
    ...
    login() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const provider = new firebase_app__WEBPACK_IMPORTED_MODULE_7__["default"].auth.GoogleAuthProvider();
            const user = yield this.firebaseAuth.signInWithPopup(provider);
            if (user) {
...
/***/ "snKG":
/*!************************************************!*\
  !*** ./src/app/services/saved-news.service.ts ***!
  \************************************************/
/*! exports provided: SavedNewsService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SavedNewsService", function() { return SavedNewsService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "fXoL");
...
let SavedNewsService = class SavedNewsService {
...
SavedNewsService.ctorParameters = () => [
    { type: _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_2__["AngularFirestore"] },
    { type: _auth_service__WEBPACK_IMPORTED_MODULE_4__["AuthService"] }
];
SavedNewsService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root',
    })
], SavedNewsService);
